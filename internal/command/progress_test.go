...
func TestProgressDescription(t *testing.T) {
	...
	tests := []struct {
		...
		{args: []string{"logs", "10.46.96.160"}, want: "Fetching system and Lifecycle Controller logs..."},
		{args: []string{"logs", "system", "10.46.96.160"}, want: "Fetching System Event Log..."},
		{args: []string{"logs", "lc", "10.46.96.160"}, want: "Fetching Lifecycle Controller logs..."},
